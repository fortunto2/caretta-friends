...
Caretta Gazipaşa monitors Koru, Selinus, and Kahyalar beaches, ~150–200 nests/season; incubation locally cited at ~55–60 days. Beach access is legally prohibited after 20:00 during nesting season (with fines), meaning enforcement/reporting of human disturbance is part of the volunteer's job. Volunteers cordon nests with tape and place fundraised protective cages. Nearby DEKAMER (Dalyan/Muğla) runs the same protocol at Iztuzu Beach, and also covers the neighboring **Dalaman–Sarıgerme beach** (~15km stretch, İztuzu–Sarıgerme–Dalaman) with nightly monitoring and trained Sarıgerme hotel staff for nesting season — no separate Dalaman-specific NGO/municipality program exists, DEKAMER is the sole on-the-ground operator there too, led by Prof. Dr. Yakup Kaska (Pamukkale University). Fethiye and Patara — other major Turkish loggerhead sites — remain flagged by MEDASSET/the Bern Convention as under threat from unmanaged tourism, light pollution, and dune erosion (Fethiye's case still "Open File" as of the 2025 Standing Committee review) — meaning consistent, exportable, timestamped digital nest records could carry secondary value as evidence for habitat-protection advocacy. Critically: **no data-collection app or tool of any kind is mentioned anywhere in Caretta Gazipaşa's own materials**, confirming this is a genuine paper/manual-only operation today.

**Outreach contact for DEKAMER** (relevant if Caretta Gazipaşa or this project ever wants a pilot partner beyond Gazipaşa): dekamer.org.tr · dekamerturkey@gmail.com · +90 252 289 00 77 (emergency/mobile +90 538 403 2501) · Instagram/Facebook @dekamerturkey.

### 2.3 National Landscape: Conservation Orgs Across All 20 Turkish Nesting Beaches

A follow-up research pass (July 2026, tracked in `docs/conservation-partners-raw.json` and distilled into `composeApp/src/commonMain/composeResources/files/content/en/partners.md`, which already ships in-app) mapped named, contactable conservation operators for **18 of Turkey's 20 nationally recognized Caretta caretta / Chelonia mydas nesting beaches**. The remaining 2 — Tekirova and Göksu Delta — have **no operator of their own**: Tekirova's nests are informally folded into the neighboring Çıralı Ulupınar Cooperative's program (below) and, more broadly, sit within EKAD's Antalya-arc territory (alongside Belek, Kızılot, Kumluca); Göksu Delta (a Ramsar wetland and Special Environmental Protection Area on the Mersin/Silifke coast) falls within Mersin University DEKUYAM's regional coverage, with DKMP as the official custodian given its SEPA/Ramsar status. No independent Göksu-specific NGO/program surfaced in either research pass, and no Tekirova-specific one beyond its informal link to Çıralı — a genuine, verified gap, not an invented placeholder. The picture confirms and extends the gap analysis in §1: this is not just a Gazipaşa or Dalyan phenomenon, it's the norm along the entire Turkish Mediterranean coast. No beach in this survey showed evidence of a digital nest-monitoring tool of any kind — every operator runs on paper/manual field methods, exactly as found for ARCHELON and DEKAMER earlier in this report.

The operator landscape sorts into three tiers:

- **University research centers** — DEKAMER (Pamukkale University, Dalyan) is the largest single player, with direct or referral coverage spanning İztuzu, Dalaman-Sarıgerme, Ekincik, and rescue/rehab referrals from Fethiye, Patara, Demirtaş, and Alata. Others cover their own regional clusters: Mersin University's DEKUYAM center (Alata/Erdemli, Kazanlı, Anamur — director Prof. Dr. Serap Ergene), ÇOMÜ DEKUM (Çanakkale Onsekiz Mart University, contributed the 2020 Demre/Kale survey), Çukurova University (Biology + Faculty of Fisheries, Akyatan/Yumurtalık), Akdeniz University and Hacettepe University (named academic experts, Antalya-coast and Kızılot respectively), Sivas Cumhuriyet University (Prof. Dr. Bektaş Sönmez, lead researcher for Çıralı since ~2013).
- **NGOs** — EKAD (Ekolojik Araştırmalar Derneği, Ankara-based, founded 2003) is the second-largest player, running dedicated field camps at Belek and Kızılot and covering Demirtaş and Kumluca too — its Belek project alone is in its 32nd season (since 1994) on ~29.5km of coast, one of the two largest loggerhead nesting sites in the Mediterranean. MEDASSET (Athens) is the recurring international advocacy/Bern Convention watchdog, with documented campaigns at Fethiye, Patara, Ekincik/Dalyan, Anamur, and Kazanlı going back to 1999. WWF-Türkiye runs the green-turtle program at Akyatan (20+ years, ~280,000 hatchlings tracked) and contributed to Yumurtalık research. DEKAFOK is a smaller regional NGO (Manavgat) of uncertain reach to Gazipaşa specifically.
- **Local/grassroots groups** — Kaptan June Sea Turtle Conservation Foundation (İztuzu/Dalyan, founded 2011, named for the activist who saved the beach from development in the 1980s), LİDOSK (a scouting/nature-sports NGO running the Demre project since 2020), the Ulupınar Environmental Cooperative (volunteer-run at Çıralı/Tekirova since ~1994-99, ~100+ nests/season), Gönüllü Projeleri's Anamur volunteer patrol, and MERÇED (Mersin watchdog NGO). **Caretta Gazipaşa itself appears in this same survey** as the identified operator for Gazipaşa's beaches, alongside a named grassroots effort (teacher Güldane Şahin + the district search-and-rescue unit, AKUB) — confirming the org's own position within this same landscape, not just as a hypothetical adopter.
- **Official government bodies** — the Ministry of Agriculture and Forestry's Nature Conservation & National Parks Directorate (DKMP), split into a 6th Regional Directorate (Burdur, covering Antalya/Burdur/Isparta — Gazipaşa, Kumluca, Demre, Çıralı, Tekirova, Belek, Kızılot) and a 7th Regional Directorate (Adana — Akyatan, Yumurtalık), plus the General Directorate for Protection of Natural Assets (TVK) which formally designates and funds SEPA-level protection (e.g. Patara, Fethiye-Göcek), and several coastal municipalities (Fethiye, Kemer, Akdeniz/Mersin) that fund cleanups/awareness without running the science themselves.

**Practical implication:** this list is a ready-made partnership/expansion target list, not just a market-sizing exercise — it gives concrete named contacts (websites, Instagram handles, phone numbers, emails) for roughly 15-18 distinct organizations across Turkey alone that could be approached to pilot the app beyond Gazipaşa, well before reaching for the broader Mediterranean coalition or global SWOT pool discussed in §8.

### 2.4 Volunteer & Organizational Pain Points
...
### 2.5 Synthesis — What This Means for the App
...
- **Immediate beachhead (Turkey + Greece + Cyprus):** ARCHELON alone runs **8 active volunteer project sites** in Greece (Zakynthos, Kyparissia Bay, Lakonikos Bay, Koroni, Rethymno, Chania, Messara Bay, Amvrakikos Gulf); Cyprus has two active NGOs, SPOT (North, ~2,400 nests/year — an all-time record) and MedTRACS (South, est. 2022). Turkey is now mapped in detail (§2.3): **18 of 20 nationally recognized nesting beaches have an identified, contactable conservation operator** — spanning university centers (DEKAMER/Pamukkale, Mersin Uni's DEKUYAM, ÇOMÜ DEKUM, Çukurova, Akdeniz, Sivas Cumhuriyet, Hacettepe), NGOs (EKAD, MEDASSET, WWF-Türkiye, DEKAFOK), and local/grassroots groups (Kaptan June Foundation, LİDOSK, Ulupınar Cooperative, Gönüllü Projeleri, MERÇED) — roughly **15-18 distinct named organizations** with public contact details (website, Instagram, phone, email) now collected in `docs/conservation-partners-raw.json` and distilled into the in-app partner directory. None showed any evidence of a digital nest-monitoring tool. Combined with Greece and Cyprus, the realistic near-term beachhead is **20-25+ distinct beach-monitoring operations**, most run by small teams with no digital tool today and several already identified as concrete outreach targets, not just a market-sizing abstraction.
...
### Turkey national conservation-org landscape (§2.3)
132. `docs/conservation-partners-raw.json` — raw per-beach research output, 18 of 20 Turkish nesting beaches, org-keyed (project-internal file, not a public URL)
133. `composeApp/src/commonMain/composeResources/files/content/en/partners.md` — distilled, deduped partner directory shipped in-app (project-internal file, not a public URL)
134. [EKAD — Ekolojik Araştırmalar Derneği](https://ekad.org.tr)
135. [Mersin University Sea Turtle Application & Research Center (DEKUYAM)](https://www.mersin.edu.tr/akademik/deniz-kaplumbagalari-uygulama-ve-arastirma-merkezi)
136. [ÇOMÜ DEKUM — Çanakkale Onsekiz Mart University Sea Turtle Research Center](https://dekum.comu.edu.tr)
137. [WWF-Türkiye](https://www.wwf.org.tr)
138. [DEKAFOK — Deniz Kaplumbağaları ve Foklar Koruma](https://www.dekafok.org.tr)
139. [Kaptan June Sea Turtle Conservation Foundation](https://dalyanturtles.com)
140. [LİDOSK — Lykia İzcilik ve Doğa Sporları Kulübü Derneği](https://lidosk.org.tr)
141. [Ulupınar Çevre Koruma Geliştirme ve İşletme Kooperatifi (Çıralı)](http://www.ulupinarkoop.org)
142. [Anamur Sea Turtle & Trionyx Monitoring Project — Gönüllü Projeleri](https://gonulluprojeleri.com/anamur.html)
143. [DKMP 6th Regional Directorate (Burdur/Antalya)](https://bolge6.tarimorman.gov.tr)
144. [DKMP 7th Regional Directorate (Adana)](https://bolge7.tarimorman.gov.tr)
145. [TVK — General Directorate for Protection of Natural Assets](https://tvk.csb.gov.tr/)
